...
import { faAreaChart, faBed, faHeart, faCopy, faLocation, faMoneyCheck, faShare, faToilet } from '@fortawesome/free-solid-svg-icons'
...
const LandLeasePage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const result = await axios(
        'http://localhost:8800/api/landLease/randomlandleases', // Thay thế bằng đường dẫn API của bạn
      );
      setData(result.data);
    };
    fetchData();
  ...
  useEffect(() => {
    axios.get(`http://localhost:8800/api/landLease/find/${landleaseId}`)
      .then(response => {
          ...
          <div className="ultitilandsaledetail">
            <div className="groupinfolandsale">
              <div className="arealandsaledetail">
                  ...
                  <p className='plandsaledetailunder'>{houseData.price} triệu/tháng</p>
              </div>
              <div className="arealandsaledetail">
            ...
            <div className="sharelikelandsale">
              ...
              <div className="iconhertlikedetail">
                <FavoriteButton userId={userLocal._id} landleaseId={houseData._id} onClick={(event) => event.stopPropagation()}/>
              </div>
            </div>
          </div>
            ...
            <div className="groupleftrightcharacdetaillandsale">
              ...
              <div className="grouprightcharaclandsaledetail">
                  <div className="grouptopcharaclandsaledetail">
                    ...
                    <div className="ptopright">{houseData.price} triệu/tháng</div>
                  </div>
                  <div className="groupbottomcharaclandsaledetail">
